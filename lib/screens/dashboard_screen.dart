                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      AlertCard(
                                        ...
                                        description: '3 animais precisam receber vacina contra clostridiose',
                                        icon: Icons.vaccines,
                                        color: theme.colorScheme.error,
                                        onTap: () {},
                                      ),
                                      ...
                                      AlertCard(
                                        ...
                                        description: 'Benedita (OV001) - Previsão para 20/12/2024',
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      const SizedBox(height: 16),
                                      ...[
                                        (Icons.add, 'Registrar Nascimento'),
                                        (Icons.calendar_today, 'Agendar Vacinação'),
                                        (Icons.location_on, 'Movimentar Animais'),
                                        (Icons.trending_up, 'Relatório Mensal'),
                                      ].map((action) => Padding(
